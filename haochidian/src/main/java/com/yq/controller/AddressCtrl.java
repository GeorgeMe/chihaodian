...
public class AddressCtrl extends StringUtil{
	...
	String area ,String addr_user,String addr_name,
			String addr_tel, String oppen_id,String sort,HttpSession session) throws UnsupportedEncodingException {
...
//			map.put("sort", datetime);
	...
	public String update(String province , String city ,
			String area ,String addr_user,String addr_name,
			String addr_tel, String oppen_id,Integer addr_id,HttpSession session) throws UnsupportedEncodingException {
//			setOppen_id("111", session);//测试代码，模仿登录
//			oppen_id=getOppen_id(session);
		if(StringUtils.isNotEmpty(addr_user)){
			addr_user = java.net.URLDecoder.decode(addr_user,"utf-8") ;
