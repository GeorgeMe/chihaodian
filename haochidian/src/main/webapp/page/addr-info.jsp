    ...
    <script type="text/javascript">
			function add() {
				...
				$.ajax({
					url : 'addrUpdate.html',
					type : 'post',
					data : 'addr_user=' + encodeURI(addr_user) + '&addr_tel=' + addr_tel
					+ '&addr_name=' + encodeURI(addr_name)+ '&addr_id=' + addr_id+ '&province=' + encodeURI(province)+ '&city=' + encodeURI(city)+ '&area=' + encodeURI(area),
					success : function(rs) {
						if (rs == 1) {
